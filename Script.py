class script(object):
    START_TXT = """<b>Hᴇʏ 👋 {} ɪ ᴀᴍ ᴀɴ Aᴡᴇsᴏᴍᴇ Aᴜᴛᴏ + Mᴀɴᴜᴀʟ Fɪʟᴛᴇʀ + Fɪʟᴇ Sʜᴀʀᴇ Bᴏᴛ.
ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ɪɴ ɢʀᴏᴜᴘs</b>"""
...
"""
    ...
    ABOUT_TXT = """<b>🤖 ᴍʏ ɴᴀᴍᴇ : ᴍᴏᴠɪᴇs ғɪʟᴛᴇʀ ʙᴏᴛ
👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ : 
📝 ʟᴀɴɢᴜᴀɢᴇ : ᴘʏʀᴏɢʀᴀᴍ
📚 ꜰʀᴀᴍᴇᴡᴏʀᴋ : ᴘʏᴛʜᴏɴ 3
📡 ʜᴏsᴛᴇᴅ ᴏɴ : sᴏᴍᴇᴡʜᴇʀᴇ</b>"""
