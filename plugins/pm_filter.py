...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>please join @Ms_Links_TG for movies !</b>")
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("♨️ Cʜᴇᴄᴋ Bᴏᴛ PM ♨️", url=f"https://t.me/{temp.U_NAME}")
    ])
    try:
    ...
    if k == False:
        ...
        if files:
            ...
            await auto_filter(bot, query, k)
             ...
             k = await query.message.edit('Sᴏʀʀʏ Pʟᴇᴀsᴇ Cʜᴇᴄᴋ Yᴏᴜʀ Sᴩᴇʟʟɪɴɢ Iɴ Gᴏᴏɢʟᴇ Fɪʀsᴛ ﹦ Iғ Yᴏᴜʀ Sᴩᴇʟʟɪɴɢ Cᴏʀʀᴇᴄᴛ Mᴇᴀɴs Tʜᴀᴛ Fɪʟᴇ Nᴏᴛ ғᴏᴜɴᴅ Iɴ Mʏ Dᴀᴛᴀʙᴀsᴇ 💌')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📡 Uᴘᴅᴀᴛᴇs', url='https://t.me/MovieStore_TG'),
            InlineKeyboardButton('👥 Gʀᴏᴜᴘ', url='https://t.me/Ms_Links_TG')
            ],[
            InlineKeyboardButton('👑 Oᴡɴᴇʀ', url='https://t.me/Moviestore_admin_bot'), 
        ...
        buttons = [[
            InlineKeyboardButton('📡 Uᴩᴅᴀᴛᴇs', url='https://t.me/MovieStore_TG'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>▶️ Rᴇǫᴜᴇsᴛᴇᴅ Bʏ : {message.from_user.mention} \n▶️ Yᴏᴜʀ Qᴜᴇʀʏ : #{search} \n\n📂 Tᴏᴛᴀʟ Fɪʟᴇs : {str(total_results)}</b>"
